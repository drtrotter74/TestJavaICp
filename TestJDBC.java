...
public class TestJDBC 
{
  public static void main(String[] args) 
  {
    ...
    System.out.println ("**** Enter class TestJDBC");
    ...
    {                                                                        
      ...
      rs = stmt.executeQuery("SELECT NAME FROM SYSIBM.SYSTABLES FETCH FIRST 20 ROWS ONLY");                   
      ...
      System.out.println("**** JDBC Exit from class TestJDBC - no errors");
